...
## Auto-setup the python environment

```{r python initiate, warning=FALSE, eval=FALSE}
py_ini()
```
...
```{r eval=FALSE, fig.height=8, fig.show='asis', fig.width=8, warning=FALSE, include=FALSE}
# Not show 
